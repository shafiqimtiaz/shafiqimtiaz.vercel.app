      ...
      <div className="border-b border-[rgba(73,72,71,0.5)] bg-[var(--theme-surface-low)]/95 shadow-[var(--shadow-primary)] backdrop-blur-xl">
        <div className="mx-auto flex min-h-[var(--header-height)] w-[min(100%-2rem,var(--container-width))] items-center gap-5">
          ...
          <div className="flex items-center gap-2">
            <button
              className="inline-flex h-11 w-11 items-center justify-center border border-[var(--theme-outline-variant)] bg-[var(--theme-surface)] text-[var(--theme-primary)] transition-[background-color,border-color] duration-200 hover:border-[var(--theme-primary)] hover:bg-[var(--theme-surface-high)] md:hidden"
              type="button"
