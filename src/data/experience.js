...
export const timeline = [
  ...
  },
  {
    ...
    details: [
      ...
      'Led the Spring Boot 3 migrations of Flexspring Studio and Monitor API — framework dependencies updated, breaking API changes resolved, validated end-to-end, deployed with zero regression. Refactored the Webhook Core Jenkinsfile to improve CI/CD reliability.',
      ...
      'Upgraded Monitor UI to React 18.3, React Router v7, and Vite 7; migrated data-fetching to @tanstack/react-query (v5) and upgraded the shared React component library.',
      'Wrote unit tests for File Manager covering core operations and permission enforcement; extended coverage for skill-installer, routing-builder, and config-generator modules.',
      'Mentored three team members on Monitor architecture and File Manager internals; authored internal service documentation and ran code reviews across Monitor and Studio.',
  ...
  },
  {
    ...
    details: [
      ...
      'Engineered ETL pipelines integrating 40+ supplier systems into PostgreSQL-based procurement analytics with 100% audit compliance; developed a Python (Scikit-learn, Pandas) ML forecasting module that reduced overstock by 15%.',
    ],
  },
];
