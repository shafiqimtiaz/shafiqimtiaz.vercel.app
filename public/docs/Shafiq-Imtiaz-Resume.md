...
* Leading lifecycle-driven provisioning across Studio, Services, and Wizard, connecting AI-generated integration design with automated credentials and mapping/lookup-table setup

### Software and AI Engineer | Flexspring | Ottawa, ON | May 2024 - Aug 2026

* Built production AI capabilities for Data Mapping and platform LLM integration, plus AI-assisted transaction-detail views for simplified review, improving recommendation quality, reliability, and governance across Monitor and shared libraries
...
* Designed and implemented Monitor and Studio Lifecycle end-to-end across project and integration flows, storing lifecycle events on the integration entity for traceability and debugging while connecting user experience, services, and data models
* Built Monitor's Service Manager, covering service listings, subscribe/unsubscribe flows, and subscription-based availability gating for services like File Manager and Approval Manager
...
* Built Studio V2 AI Analysis end-to-end, providing role-based integration quality assessments and optimization recommendations; led Studio's Spring Boot 3 migration and broader platform modernization
* Delivered Credentials Manager full-stack, including API, ConnectorHub integration, React UI, secure field handling, notifications, and request lifecycle management
...
* Delivered Monitor Pilot's template-based UI across authentication, navigation, dashboards, organization and integration summaries, executions, transactions, and transaction details
* Built the foundation of Monitor Credentials Manager, delivering full-stack credential listing and add/update workflows with connector-specific forms, validation, caching, and search optimization
